  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "The total block lifts and is replaced by a 30-minute shared daily budget across your blocked apps. You allocate it: 20 minutes for Instagram and 10 for YouTube, all 30 on one app, or none at all. The point was never zero phone use forever. After a real reset, 30 intentional minutes feels like enough, and you're the one deciding where they go. Not the algorithm.",
      },
      {
        question: "Will I lose messages, accounts, or followers during the detox?",
        answer:
          "No. Blocking an app doesn't log you out, delete anything, or touch your account. Your DMs, followers, and content are all exactly where you left them on day 14. The only thing you lose is two weeks of other people's content. That was the point.",
      },
    ],
  },
  {
...
// FAQPage structured data for all questions, used for rich results
const faqSchema = {
